...
public class ElementItem {
    ...
    public static final Map<String, RegistryObject<Item>> CRUSHED_RAW = new HashMap<>();
    public static final Map<String, RegistryObject<Item>> RAW = new HashMap<>();
    public static final Map<String, RegistryObject<Item>> CYLINDERS = new HashMap<>();
    ...
    // 辅助方法：通过元素名获取物品
    // 锭
    public static RegistryObject<Item> getIngot(String elementName) {
        return INGOTS.get(elementName.toLowerCase());
    }
    // 粒
    public static RegistryObject<Item> getNugget(String elementName) {
        return NUGGETS.get(elementName.toLowerCase());
    }
    // 粉
    public static RegistryObject<Item> getDust(String elementName) {
        return DUSTS.get(elementName.toLowerCase());
    }
    // 板
    public static RegistryObject<Item> getPlate(String elementName) {
        return PLATES.get(elementName.toLowerCase());
    }
    // 棍
    public static RegistryObject<Item> getRod(String elementName) {
        return RODS.get(elementName.toLowerCase());
    }
    // 线
    public static RegistryObject<Item> getWire(String elementName) {
        return WIRES.get(elementName.toLowerCase());
    }
    // 齿轮
    public static RegistryObject<Item> getGear(String elementName) {
        return GEARS.get(elementName.toLowerCase());
    }
    // 粗矿
    public static RegistryObject<Item> getRaw(String elementName) {
        return RAW.get(elementName.toLowerCase());
    }
    // 粉碎粗矿
    public static RegistryObject<Item> getCrushedRaw(String elementName) {
        return CRUSHED_RAW.get(elementName.toLowerCase());
    }
    // 气体瓶
    public static RegistryObject<Item> getCylinder(String elementName) {
    ...
    // 气瓶
    public static final RegistryObject<Item> GAS_CYLINDER =
